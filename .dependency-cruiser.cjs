...
module.exports = {
  forbidden: [
    {
      name: 'domain-should-not-depend-on-features-or-pages',
      severity: 'error',
    ...
    {
      name: 'features-should-not-depend-on-other-features',
      severity: 'error',
    ...
    {
      name: 'ui-components-should-be-leafs',
      severity: 'error',
    ...
    {
      name: 'providers-should-not-depend-on-pages',
      severity: 'error',
...
// generated: dependency-cruiser@17.3.8 on 2026-02-15T13:00:03.101Z
